...
**Parameter:**
  Comma-separated sports filter


**Parameter:**
  Target sportsbooks to find +EV on (e.g., `draftkings,fanduel`)


**Parameter:**
  Minimum EV percentage to return


## Response

**Response Field:**
  Summary statistics for opportunities found


**Response Field:**
  Array of +EV betting opportunities
